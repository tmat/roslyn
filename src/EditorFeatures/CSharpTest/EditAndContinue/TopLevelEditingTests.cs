...
";
        ...
        public void PartialMember_RenameInsertDelete()
        {
            ...
            // current outcome:
            GetTopEdits(srcA1, srcA2).VerifyRudeDiagnostics(Diagnostic(RudeEditKind.Renamed, "void F2()", "method"));
            GetTopEdits(srcB1, srcB2).VerifyRudeDiagnostics(Diagnostic(RudeEditKind.Renamed, "void F1()", "method"));
...
class C
{
    public int this[int i] { get { return 0; } }
            ...
            edits.VerifyRudeDiagnostics(
                Diagnostic(RudeEditKind.Delete, "public int this[int i]", CSharpFeaturesResources.indexer_setter));
        }
