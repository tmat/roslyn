...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed class SyntheticBoundNodeFactory
    {
        ...
        public BoundExpression AssignmentExpression(BoundExpression left, BoundExpression right, bool isRef = false)
        {
            ...
            var assignment = AssignmentExpression(Syntax, left, right, left.Type, isRef: isRef);
            // TODO: assignment.WasCompilerGenerated = true;
            return assignment;
        }
        ...
        /// Creates a general assignment that might be instrumented.
        /// </summary>
        public BoundExpression AssignmentExpression(SyntaxNode syntax, BoundExpression left, BoundExpression right, TypeSymbol type, bool isRef = false, bool hasErrors = false)
        {
            var assignment = new BoundAssignmentOperator(syntax, left, right, isRef, type, hasErrors);
