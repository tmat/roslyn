...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed partial class LocalRewriter : BoundTreeRewriterWithStackGuard
    {
            ...
            out bool sawAwaitInExceptionHandler)
        {
            ...
            try
            {
                ...
                if (instrumentations.Kinds.Contains(InstrumentationKind.LocalStateTracing) &&
                    LocalStateTrackingInstrumenter.TryCreate(method, statement, factory, diagnostics, instrumenter, out var localStateTrackingInstrumenter))
                {
                ...
                codeCoverageSpans = (testCoverageInstrumenter != null) ? testCoverageInstrumenter.DynamicAnalysisSpans : default;
#if DEBUG
        ...
        private Instrumenter Instrumenter => _instrumenter;
