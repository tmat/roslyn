    ...
    internal partial class CodeGenerator
    {
        ...
        private void EmitConstantExpression(TypeSymbol type, ConstantValue constantValue, bool used, SyntaxNode syntaxNode)
        {
            if (used)  // unused constant has no side-effects
            {
                ...
                {
                    // TODO: Dependencies are dropped: https://github.com/dotnet/roslyn/issues/78172
                    if (constantValue.IsString && constantValue.StringValue.Length > _module.CommonCompilation.DataSectionStringLiteralThreshold)
                    {
                        Binder.GetWellKnownTypeMember(_module.Compilation, WellKnownMember.System_Text_Encoding__get_UTF8, _diagnostics, syntax: syntaxNode);
                        Binder.GetWellKnownTypeMember(_module.Compilation, WellKnownMember.System_Text_Encoding__GetString, _diagnostics, syntax: syntaxNode);
                    }
