...
namespace Microsoft.CodeAnalysis.UnitTests
{
    public class DocumentInfoTests
    {
        ...
        public void Create()
        {
            var loader = new FileTextLoader(Path.GetTempPath(), defaultEncoding: null, checksumAlgorithm: Text.SourceHashAlgorithm.Sha256);
        ...
        public void TestProperties()
        {
            ...
            SolutionTestHelpers.TestProperty(instance, (old, value) => old.WithTextLoader(value), opt => opt.TextLoader, (TextLoader)new FileTextLoader(Path.GetTempPath(), defaultEncoding: null, checksumAlgorithm: SourceHashAlgorithm.Sha256));
