...
internal partial class CSharpSyntaxTreeFactory
{
    ...
    internal sealed class RecoverableSyntaxTree : CSharpSyntaxTree, IRecoverableSyntaxTree<CSharpSyntaxNode>, ICachedObjectOwner
    {
        ...
        private readonly AbstractSyntaxTreeFactory _service;
        ...
        private RecoverableSyntaxTree(AbstractSyntaxTreeFactory service, ProjectId cacheKey, CSharpSyntaxNode root, SyntaxTreeInfo info)
        {
        ...
        internal static SyntaxTree CreateRecoverableTree(
            AbstractSyntaxTreeFactory service,
            ProjectId cacheKey,
            string filePath,
