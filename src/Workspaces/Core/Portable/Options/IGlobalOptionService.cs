...
internal interface IGlobalOptionService : IOptionsReader
{
    ...
    void AddOptionChangedHandler(WeakEventHandler<OptionChangedEventArgs> handler);

    void RemoveOptionChangedHandler(WeakEventHandler<OptionChangedEventArgs> handler);
}
