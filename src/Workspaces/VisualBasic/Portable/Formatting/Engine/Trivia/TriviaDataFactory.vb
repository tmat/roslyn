...
Namespace Microsoft.CodeAnalysis.VisualBasic.Formatting
    ...
    Partial Friend Class TriviaDataFactory
        ...
        Public Sub New(treeInfo As TreeData, options As VisualBasicFormatterOptions)
        ...
        Private Function GetLineBreaksAndIndentation(result As Analyzer.AnalysisResult) As ValueTuple(Of Boolean, Integer, Integer)
            ...
            Debug.Assert((indentation \ Me.Options.TabSize) = result.Tab)
            Debug.Assert((indentation Mod Me.Options.TabSize) = result.Space)
