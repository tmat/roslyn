...
Namespace Microsoft.CodeAnalysis.VisualBasic
    Partial Friend Class VisualBasicSyntaxTreeFactory
        ...
        Friend NotInheritable Class RecoverableSyntaxTree
            ...
            Private ReadOnly _service As AbstractSyntaxTreeFactory
            ...
            Private Sub New(service As AbstractSyntaxTreeFactory, cacheKey As ProjectId, root As VisualBasicSyntaxNode, info As SyntaxTreeInfo)
            ...
            Friend Shared Function CreateRecoverableTree(service As AbstractSyntaxTreeFactory,
