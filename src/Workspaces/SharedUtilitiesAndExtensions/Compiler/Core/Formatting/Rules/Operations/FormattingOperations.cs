...
namespace Microsoft.CodeAnalysis.Formatting.Rules
{
    internal static class FormattingOperations
    {
        ...
        /// </summary>
        internal static IEnumerable<SuppressOperation> GetSuppressOperations(IEnumerable<AbstractFormattingRule> formattingRules, SyntaxNode node, FormatterOptions options)
        {
        ...
        /// </summary>
        internal static IEnumerable<AnchorIndentationOperation> GetAnchorIndentationOperations(IEnumerable<AbstractFormattingRule> formattingRules, SyntaxNode node, FormatterOptions options)
        {
            var chainedFormattingRules = new ChainedFormattingRules(formattingRules, options);
        ...
        /// </summary>
        internal static IEnumerable<IndentBlockOperation> GetIndentBlockOperations(IEnumerable<AbstractFormattingRule> formattingRules, SyntaxNode node, FormatterOptions options)
        {
            var chainedFormattingRules = new ChainedFormattingRules(formattingRules, options);
        ...
        /// </summary>
        internal static IEnumerable<AlignTokensOperation> GetAlignTokensOperations(IEnumerable<AbstractFormattingRule> formattingRules, SyntaxNode node, FormatterOptions options)
        {
            var chainedFormattingRules = new ChainedFormattingRules(formattingRules, options);
        ...
        /// </summary>
        internal static AdjustNewLinesOperation? GetAdjustNewLinesOperation(IEnumerable<AbstractFormattingRule> formattingRules, SyntaxToken previousToken, SyntaxToken currentToken, FormatterOptions options)
        {
            var chainedFormattingRules = new ChainedFormattingRules(formattingRules, options);
        ...
        /// </summary>
        internal static AdjustSpacesOperation? GetAdjustSpacesOperation(IEnumerable<AbstractFormattingRule> formattingRules, SyntaxToken previousToken, SyntaxToken currentToken, FormatterOptions options)
        {
            var chainedFormattingRules = new ChainedFormattingRules(formattingRules, options);
