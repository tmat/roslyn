...
namespace Microsoft.CodeAnalysis.Formatting
{
    internal abstract partial class AbstractTriviaDataFactory
    {
        ...
        protected class Whitespace : TriviaData
        {
            ...
            public Whitespace(FormatterOptions options, int space, bool elastic, string language)
                : this(options, lineBreaks: 0, indentation: space, elastic: elastic, language: language)
            {
                Contract.ThrowIfFalse(space >= 0);
            }

            public Whitespace(FormatterOptions options, int lineBreaks, int indentation, bool elastic, string language)
