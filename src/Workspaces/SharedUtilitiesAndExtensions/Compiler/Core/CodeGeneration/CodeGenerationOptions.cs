...
internal static class CodeGenerationOptionsProviders
{
    ...
    public static CodeAndImportGenerationOptions GetCodeAndImportGenerationOptions(this IOptionsReader options, LanguageServices languageServices, bool? allowImportsInHiddenRegions)
        => new()
        {
    ...
    public static CleanCodeGenerationOptions GetCleanCodeGenerationOptions(this IOptionsReader options, LanguageServices languageServices, bool? allowImportsInHiddenRegions)
        => new()
        {
            GenerationOptions = options.GetCodeGenerationOptions(languageServices),
