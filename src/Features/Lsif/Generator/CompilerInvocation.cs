        ...
        public static async Task<Project> CreateFromInvocationInfoAsync(CompilerInvocationInfo invocationInfo)
        {
            ...
            var projectInfo = ProjectInfo.Create(
                new ProjectInfo.ProjectAttributes(
                    ...
                    compilationOutputInfo: new CompilationOutputInfo(parsedCommandLine.OutputFileName != null ? Path.Combine(parsedCommandLine.OutputDirectory, parsedCommandLine.OutputFileName) : null),
