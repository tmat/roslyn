...
namespace Microsoft.CodeAnalysis.Wrapping.ChainedExpression
{
        ...
        TBaseArgumentListSyntax>
    {
            ...
            AbstractCodeActionComputer<AbstractChainedExpressionWrapper<TNameSyntax, TBaseArgumentListSyntax>>
        {
            ...
            {
                actions.Add(await TryCreateCodeActionAsync(GetWrapEdits(Options.PreferredWrappingColumn, align: false), FeaturesResources.Wrapping, FeaturesResources.Wrap_long_call_chain).ConfigureAwait(false));
                actions.Add(await TryCreateCodeActionAsync(GetWrapEdits(Options.PreferredWrappingColumn, align: true), FeaturesResources.Wrapping, FeaturesResources.Wrap_and_align_long_call_chain).ConfigureAwait(false));
            }
