...
#Region "Syntax And Semantic Utils"
        ...
        Friend Overrides Function IsPartialDefinition(method As IMethodSymbol) As Boolean
            Return method.PartialImplementationPart IsNot Nothing OrElse
                   method.DeclaringSyntaxReferences.Length = 1 AndAlso IsPartialMethodDefinitionPart(method.DeclaringSyntaxReferences(0).GetSyntax())
        End Function
