...
namespace Microsoft.CodeAnalysis.CSharp.EditAndContinue
{
    internal sealed class CSharpEditAndContinueAnalyzer : AbstractEditAndContinueAnalyzer
    {
        ...
        internal override bool IsPartialDefinition(IMethodSymbol method)
            => method.PartialImplementationPart != null ||
               method.DeclaringSyntaxReferences.Length == 1 && IsPartialMethodDefinitionPart(method.DeclaringSyntaxReferences[0].GetSyntax());
