    ...
    public class SolutionServiceTests
    {
        ...
        public async Task TestAddingProjectsWithExplicitOptions(bool useDefaultOptionValue)
        {
            ...
            solution = solution.WithOptions(solution.Options
                .WithChangedOption(new OptionKey(FormattingOptions.NewLine, LanguageNames.CSharp), newOptionValue)
                .WithChangedOption(new OptionKey(FormattingOptions.NewLine, LanguageNames.VisualBasic), newOptionValue));
