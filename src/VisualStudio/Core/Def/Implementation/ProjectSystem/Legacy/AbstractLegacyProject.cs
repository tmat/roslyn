...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.ProjectSystem.Legacy
{
    ...
    internal abstract partial class AbstractLegacyProject : ForegroundThreadAffinitizedObject
    {
            ...
            : base(threadingContext)
        {
            ...
            try
            {
                _externalErrorReporter = new ProjectExternalErrorReporter(VisualStudioProject.Id, externalErrorReportingPrefix, (VisualStudioWorkspaceImpl)Workspace, componentModel.GetService<ExternalErrorDiagnosticUpdateSource>());
