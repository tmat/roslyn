...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.Options
{
    internal sealed class LocalUserRegistryOptionPersister
    {
        ...
        public bool TryFetch(OptionKey optionKey, string path, string key, out object? value)
        {
            lock (_gate)
            {
        ...
        public bool TryPersist(OptionKey optionKey, string path, string key, object? value)
        {
