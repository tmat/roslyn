...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.Options
{
    ...
    internal sealed class VisualStudioSettingsOptionPersister
    {
        ...
        /// </summary>
        private readonly Dictionary<string, List<(OptionKey optionKey, string storageKey)>> _optionsToMonitorForChanges = new();
        ...
        {
            List<(OptionKey, string)>? optionsToRefresh = null;
        ...
        private bool TryGetValue(OptionKey optionKey, string storageKey, out object? value)
        {
        ...
        public bool TryFetch(OptionKey optionKey, string storageKey, out object? value)
        {
            if (_settingManager == null)
            {
        ...
        private void RecordObservedValueToWatchForChanges(OptionKey optionKey, string storageKey)
        {
            ...
            lock (_optionsToMonitorForChangesGate)
            {
                var optionKeysToMonitor = _optionsToMonitorForChanges.GetOrAdd(storageKey, _ => new List<(OptionKey optionKey, string storageKey)>());
        ...
        public bool TryPersist(OptionKey optionKey, string storageKey, object? value)
        {
            if (_settingManager == null)
            {
                Debug.Fail("Manager field is unexpectedly null.");
