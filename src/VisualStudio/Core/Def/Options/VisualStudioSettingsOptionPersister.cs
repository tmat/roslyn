...
namespace Microsoft.VisualStudio.LanguageServices.Options
{
    ...
    internal sealed class VisualStudioSettingsOptionPersister
    {
        ...
        /// </remarks>
        public VisualStudioSettingsOptionPersister(IGlobalOptionService globalOptionService, ImmutableDictionary<string, Lazy<IVisualStudioStorageReadFallback, OptionNameMetadata>> readFallbacks, ISettingsManager? settingsManager)
        {
        ...
        private Task OnSettingChangedAsync(object sender, PropertyChangedEventArgs args)
        {
            ...
            if (_optionsToMonitorForChanges.TryGetValue(storageKey, out var entry))
            {
                ...
                {
                    _globalOptionService.RefreshOption(entry.optionKey, optionValue.Value);
                }
            }
