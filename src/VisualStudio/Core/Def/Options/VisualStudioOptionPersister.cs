...
internal sealed class VisualStudioOptionPersister : IOptionPersister
{
    ...
    private readonly PackageSettingsPersister _packageSettingsPersister; // TODO
    ...
    public VisualStudioOptionPersister(
        ...
        PackageSettingsPersister packageSettingsPersister,
        ...
        FeatureFlagPersister featureFlagPersister)
    {
        ...
        _packageSettingsPersister = packageSettingsPersister;
    ...
    {
        value = null;
        return VisualStudioOptionStorage.TryGetPrimaryStorage(optionKey, out var storage) && TryFetch(storage, optionKey, out value);
    }

    public bool TryFetch(VisualStudioOptionStorage storage, OptionKey optionKey, out object? value)
        => storage switch
        {
    ...
    public bool TryPersist(OptionKey optionKey, object? value)
        => VisualStudioOptionStorage.TryGetPrimaryStorage(optionKey, out var storage) && TryPersist(storage, optionKey, value);

    public bool TryPersist(VisualStudioOptionStorage storage, OptionKey optionKey, object? value)
        => storage switch
        {
