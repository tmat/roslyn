...
internal sealed class VisualStudioOptionPersister : IOptionPersister
{
    ...
    {
        value = null;
        return VisualStudioOptionStorage.Storages.TryGetValue(optionKey.Option.ConfigName, out var storage) && TryFetch(storage, optionKey, out value);
    }
    ...
    public bool TryPersist(OptionKey2 optionKey, object? value)
        => VisualStudioOptionStorage.Storages.TryGetValue(optionKey.Option.ConfigName, out var storage) && TryPersist(storage, optionKey, value);
