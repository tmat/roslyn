...
namespace Microsoft.CodeAnalysis.Formatting
{
    ...
    internal static class FormatterHelper
    {
        ...
        internal static async Task<SyntaxTree> FormatAsync(SyntaxTree syntaxTree, ISyntaxFormattingService syntaxFormattingService, IEnumerable<TextSpan> spans, AnalyzerConfigOptions options, IEnumerable<AbstractFormattingRule> rules, CancellationToken cancellationToken)
        {
            if (syntaxTree == null)
            {
        ...
        public static SyntaxNode Format(SyntaxNode node, ISyntaxFormattingService syntaxFormattingService, AnalyzerConfigOptions options, CancellationToken cancellationToken)
        ...
        /// <param name="cancellationToken">An optional cancellation token.</param>
        /// <returns>The formatted tree's root node.</returns>
        public static SyntaxNode Format(SyntaxNode node, ISyntaxFormattingService syntaxFormattingService, SyntaxAnnotation annotation, AnalyzerConfigOptions options, IEnumerable<AbstractFormattingRule> rules, CancellationToken cancellationToken)
        {
        ...
        internal static SyntaxNode Format(SyntaxNode node, ISyntaxFormattingService syntaxFormattingService, IEnumerable<TextSpan> spans, AnalyzerConfigOptions options, IEnumerable<AbstractFormattingRule> rules, CancellationToken cancellationToken)
        {
        ...
        internal static IList<TextChange> GetFormattedTextChanges(SyntaxNode node, ISyntaxFormattingService syntaxFormattingService, IEnumerable<TextSpan> spans, AnalyzerConfigOptions options, IEnumerable<AbstractFormattingRule> rules, CancellationToken cancellationToken)
        {
            var formattingResult = GetFormattingResult(node, syntaxFormattingService, spans, options, rules, cancellationToken);
        ...
        internal static IFormattingResult GetFormattingResult(SyntaxNode node, ISyntaxFormattingService syntaxFormattingService, IEnumerable<TextSpan> spans, AnalyzerConfigOptions optionSet, IEnumerable<AbstractFormattingRule> rules, CancellationToken cancellationToken)
        {
            if (node == null)
            {
            ...
            optionSet ??= CompilerAnalyzerConfigOptions.Empty;
            rules ??= GetDefaultFormattingRules(syntaxFormattingService);
            spans ??= SpecializedCollections.SingletonEnumerable(node.FullSpan);
            var options = syntaxFormattingService.GetOptions(optionSet);
            return syntaxFormattingService.Format(node, spans, options with { AllowDisjointSpanMerging = false }, rules, cancellationToken);
        }
        ...
        public static IList<TextChange> GetFormattedTextChanges(SyntaxNode node, ISyntaxFormattingService syntaxFormattingService, AnalyzerConfigOptions options, CancellationToken cancellationToken)
